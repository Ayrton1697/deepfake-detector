...
from model import CrossModalAttention, MultiModalModel
...
class MultiModalDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if os.path.exists(text_file_path) and os.path.exists(audio_file_path) and os.path.exists(video_frames_dir):
            ...
            aux_features = self.extract_aux_features(video_file, audio_file_path, video_frames_dir, text)
    ...
    def extract_aux_features(self, video_file_path, audio_file_path, video_frames_dir, text):
        return compute_aux_features(
            video_path=video_file_path if os.path.exists(video_file_path) else None,
    ...
    def objective(trial):
        ...
        trainer = Trainer(
            ...
            data_collator=lambda data: {
                ...
                'aux_features': torch.stack([f['aux_features'] for f in data]),
